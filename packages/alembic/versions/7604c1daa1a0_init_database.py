...
Revision ID: 7604c1daa1a0
Revises: 
Create Date: 2025-09-12 14:22:33.306404
...
def upgrade() -> None:
    ...
    op.create_index('ix_rag_document_chunks_embedding_live', 'document_chunks', [sa.text('embedding')], unique=False, schema='rag', postgresql_using='ivfflat', postgresql_with={'lists': '100'}, postgresql_where=sa.text('deleted_at IS NULL'))
